...
class BookingRepository():
    ...
    def create(self, booking):
        self.connection.execute("INSERT INTO bookings(id, start_date, end_date, user_id, space_id) VALUES(%s, %s, %s, %s, %s)", [booking.id, booking.start_date, booking.end_date, booking.user_id, booking.space_id])
        return None